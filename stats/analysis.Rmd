...
# model_cdi_label <- brm(cdi_25m ~ labels + ses,
...
# model_cdi_gesture <- brm(cdi_25m ~ gestures + ses,
#                     data = data_cdi_model, family = gaussian(),
#           control = list(adapt_delta = 0.95),
#           save_all_pars = TRUE,
#           iter = 6000)%>%
...
# model_cdi_label_gesture <- brm(cdi_25m ~ labels + gestures + ses,
#                     data = data_cdi_model, family = gaussian(),
#           control = list(adapt_delta = 0.95),
#           save_all_pars = TRUE,
#           iter = 6000)%>%
...
# model_cdi_label_gesture_int <- brm(cdi_25m ~ labels * gestures + ses,
#                     data = data_cdi_model, family = gaussian(),
#           control = list(adapt_delta = 0.95),
#           save_all_pars = TRUE,
#           iter = 6000)%>%
...
# model_cdi_overlap <- brm(cdi_25m ~ labels_w_gestures + ses,
#                     data = data_cdi_model, family = gaussian(),
#           control = list(adapt_delta = 0.95),
#           save_all_pars = TRUE,
#           iter = 6000)%>%
