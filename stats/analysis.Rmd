...
ggsave("./figures/scatterplot_zero_order_correlations_long.png", height = 8, width = 12, units = "in")
...
bf_rt_1 <- bayes_factor(model_rt_label, model_rt_null, log = F)
