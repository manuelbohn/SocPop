...
data_frame(
 ...
 WAIC = c(
  ...
  weight = c(weights["model_rt_label"],weights["model_rt_gesture"],weights["model_rt_label_gesture"],weights["model_rt_label_gesture_int"],weights["model_rt_overlap"]),
...
data_frame(
 ...
 WAIC = c(
  ...
  weight = c(weights_cdi["model_cdi_label"],weights_cdi["model_cdi_gesture"],weights_cdi["model_cdi_label_gesture"],weights_cdi["model_cdi_label_gesture_int"],weights_cdi["model_cdi_overlap"]),
  bf = c("-", round(bf_cdi_2$bf,2),round(bf_cdi_3$bf,2),round(bf_cdi_4$bf,2),round(bf_cdi_1$bf,2)))%>%
